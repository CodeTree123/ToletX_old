 ...
 function hostel_search(Request $request){
    // Get the search value from the request
            ...
            $array = QueryBuilder::for(Hostel::class)
               ->allowedFilters(['thana','address','date','title', 'price','attached_toilet',
...
//flat
    function flat_search(Request $request){
      ...
      ->allowedFilters(['thana','address','date', 'price','attached_toilet','kitchen','ac','wifi','parking',
...
//hotel
      function hotel_search(Request $request){
        ...
        ->allowedFilters(['thana','date', 'price','attached_toilet','ac','wifi','parking',
...
//room
   ...
   $min_price= 0;
       ...
       //dd($min_price);
        ...
        ->allowedFilters(['thana','address','date', 'price','attached_toilet','ac','wifi','parking',
...
//resort
    function restaurant_search (){
      $array = QueryBuilder::for(Restaurant::class)
         ->allowedFilters(['thana','address','date', 'price','vehicle_type','wifi','attached_toilet','utilities','lift','furnished','hot_water',

    ...
    <div class="row shadow p-4 rounded my-5  ">
        ...
        <div class="col-12" id="rented" style="display: none;">
            <form method="POST" action="{{ route('post_rooftop_rented') }}" enctype="multipart/form-data">
                ...
                <div class="col-4 mb-3 ">
                        <label for="resort_name_rented" class="form-label me-2 fw-bold">Rooftop Name</label>
                        <input name="title" type="text" class="form-control" id="resort_name_rented" placeholder="Enter Rooftop name">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <div class="form-check ms-5 mb-2">
                            <input class="form-check-input" type="checkbox" id="p_rented" name="p_protection">
                            <label class="form-check-label" for="p_rented">
                        ...
                        <div class="form-check ms-5 mb-2">
                            <input class="form-check-input" type="checkbox" id="attatched_toilet_rented" name="toilet">
        ...
        <div class="col-12" id="wanted" style="display: none;">
            <form method="POST" action="{{ route('post_rooftop_wanted') }}">
                ...
                <div class="row">
                <div class="col-4 mb-3 ">
                        <label for="resort_name_wanted" class="form-label me-2 fw-bold">Rooftop Name</label>
                        <input name="title" type="text" class="form-control" id="resort_name_wanted" placeholder="Enter Rooftop name">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <div class="col-2 form-check mb-2">
                            <input class="form-check-input" type="checkbox" id="p_wanted" name="p_protection">
                            <label class="form-check-label" for="p_wanted">
                                Periphery Protection
                            </label>
                        </div>
                        <div class="col-2 form-check mb-2">
                        ...
                        <div class="col-2 form-check mb-2">
                            <input class="form-check-input" type="checkbox" id="attatched_toilet_wanted" name="toilet">

        ...
        <div class="col-12" id="rented" style="display: none;">
            <form method="POST" action="{{ route('post_flat_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3 ">
                        <label for="varanda_rented" class="form-label me-2 fw-bold">No. of Varanda</label>
                        <input name="varanda" type="number" class="form-control" id="varanda_rented" placeholder="Enter Varanda">
                    </div>
                    <div class="col-4 mb-3 ">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <div class="form-check ms-5 mb-2">
                            <input class="form-check-input" type="checkbox" id="cabel_tv_rented" name="cabel_tv">
            ...
            <form method="POST" action="{{ route('post_flat_wanted') }}" >
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="floor_level" type="number" class="form-control" id="floor_level_wanted" placeholder="Enter Floor Level">
                    </div>
                    <div class="col-4 mb-3 ">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="drawing" type="number" class="form-control" id="Drawing_wanted" placeholder="Enter Drawing rooms">
                    </div>
                    <div class="col-4 mb-3 ">
                        <label for="Dining_wanted" class="form-label me-2 fw-bold">No. of Dining rooms</label>
                        <input name="dining" type="number" class="form-control" id="Dining_wanted" placeholder="Enter Dining rooms">
                    </div>
                    <div class="col-4 mb-3 ">
                        <label for="Kitchen_wanted" class="form-label me-2 fw-bold">No. of Kitchen rooms</label>
                        <input name="kitchen" type="number" class="form-control" id="Kitchen_wanted" placeholder="Enter Kitchen rooms">
                    </div>
                    <div class="col-4 mb-3 ">
                        <label for="varanda_wanted" class="form-label me-2 fw-bold">No. of Varanda</label>
                        <input name="varanda" type="number" class="form-control" id="varanda_wanted" placeholder="Enter Varanda">
                    </div>
                    <div class="col-4 mb-3 ">
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <div class="row ms-5">
                            ...
                            <div class="col-2 form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="cabel_tv_wanted" name="cabel_tv">

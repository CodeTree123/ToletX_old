            ...
            <form method="POST" action="{{ route('post_pond_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3 ">
                        <label for="description_rented" class="form-label me-2 fw-bold"> Pond Used For</label>
        ...
        <div class="col-12" id="wanted" style="display: none;">
            <form method="POST" action="{{ route('post_pond_wanted') }}">
                ...
                <div class="col-4 mb-3 ">
                    ...
                    <div class="col-4 mb-3 ">
                        <label for="area_wanted" class="form-label me-2 fw-bold">Pond area</label>
                        <input name="pond_area" type="number" class="form-control" id="area_wanted" placeholder="Enter Price">
                    </div>
                    <div class="col-4 mb-3 ">
                        <label for="height_wanted" class="form-label me-2 fw-bold">Water Level</label>
                        <input name="water_level" type="number" class="form-control" id="height_wanted" placeholder="Enter Price">
                    </div>
                    <div class="col-4 mb-3">
                    ...
                    <div class="col-12 mb-3 ">
                        <label for="description_wanted" class="form-label me-2 fw-bold"> Pond Used For</label>

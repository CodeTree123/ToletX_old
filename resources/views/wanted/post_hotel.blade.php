            ...
            <form method="POST" action="{{ route('post_hotel_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="hotel_name" type="text" class="form-control" id="hostel_name_rented" placeholder="Enter Post Title">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        <label for="guest_rented" class="form-label me-2 fw-bold">Guest</label>
                        <input name="guest_count" type="number" class="form-control" id="guest_rented" placeholder="Enter Guest">
                    </div>

                    <div class="col-8 mb-3 ">
                        <label for="address_rented" class="form-label me-2 fw-bold">Location</label>
                        <input name="location" type="text" class="form-control" id="address_rented" placeholder="Enter Address">
                    </div>
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <div class="form-check ms-5 mb-2">
                            <input class="form-check-input" type="checkbox" id="attatched_toilet_rented" name="bathroom">
            ...
            <form method="POST" action="{{ route('post_hotel_wanted') }}" >
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="hotel_name" type="text" class="form-control" id="hostel_name_wanted" placeholder="Enter Post Title">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        <label for="guest_wanted" class="form-label me-2 fw-bold">Guest</label>
                        <input name="guest_count" type="number" class="form-control" id="guest_wanted" placeholder="Enter Guest">
                    </div>

                    <div class="col-8 mb-3 ">
                        <label for="address_wanted" class="form-label me-2 fw-bold">Location</label>
                        <input name="location" type="text" class="form-control" id="address_wanted" placeholder="Enter Address">
                    </div>
                    <div class="col-12 mb-3 ">
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <div class="col-2 form-check mb-2">
                            <input class="form-check-input" type="checkbox" id="attatched_toilet_wanted" name="attatched_toilet">

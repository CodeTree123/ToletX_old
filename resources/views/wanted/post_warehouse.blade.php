        ...
        <div class="col-12" id="rented" style="display: none;">
            <form method="POST" action="{{ route('post_warehouse_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3">
                        <label for="type_rented" class="form-label me-2 fw-bold">Warehouse Type</label>
                    ...
                    <div class="col-4 mb-3">
                        <label for="building_rented" class="form-label me-2 fw-bold">Building Condition</label>
                        <select id="building_rented" class="form-select" name="building_condition">
                            <option selected="">Choose...</option>
                    ...
                    <div class="col-4 mb-3 ">
                        <label for="floor_size_rented" class="form-label me-2 fw-bold">Floor Area</label>
        ...
        <div class="col-12" id="wanted" style="display: none;">
            <form method="POST" action="{{ route('post_warehouse_wanted') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3">
                        <label for="type_wanted" class="form-label me-2 fw-bold">Warehouse Type</label>
                    ...
                    <div class="col-4 mb-3">
                        <label for="building_wanted" class="form-label me-2 fw-bold">Building Condition</label>
                        <select id="building_wanted" class="form-select" name="building_condition">
                            <option selected="">Choose...</option>
                            <option value="good">good</option>
                            <option value="moderate">moderate</option>
                            <option value="best">best</option>

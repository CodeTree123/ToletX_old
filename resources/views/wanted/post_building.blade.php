            ...
            <form method="POST" action="{{ route('post_building_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="building_name" type="text" class="form-control" id="building_name_rented" placeholder="Enter Post Title">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="floor_size" type="text" class="form-control" id="floor_size_rented" placeholder="Enter Floor Size">
                    </div>
                    <div class="col-4 mb-3 ">
                        <label for="road_width_rented" class="form-label me-2 fw-bold">Road Width</label>
                        <input name="road_width" type="text" class="form-control" id="road_width_rented" placeholder="Enter Road Width">
                    </div>
            ...
            <form method="POST" action="{{ route('post_building_wanted') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="building_name" type="text" class="form-control" id="building_name_wanted" placeholder="Enter Post Title">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="building_size" type="text" class="form-control" id="building_size_wanted" placeholder="Enter Land Area">
                    </div>
                    <div class=" col-4 mb-3">
                        <label for="floor_wanted" class="form-label me-2 fw-bold">Building Type</label>
                        <select id="floor_wanted" class="form-select" name="t_build">
                        <option selected="">Choose...</option>
                            <option value="rcc">R.C.C</option>
                            <option value="Tin Shed">Tin Shed</option>
                        </select>
                    ...
                    <div class=" col-4 mb-3">
                        ...
                        <select id="floor_wanted" class="form-select" name="floor">
                        <option selected="">Choose...</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="floor_size" type="text" class="form-control" id="floor_size_wanted" placeholder="Enter Floor Size">
                    </div>
                    <div class="col-4 mb-3 ">
                        <label for="road_width_wanted" class="form-label me-2 fw-bold">Road Width</label>
                        <input name="road_width" type="text" class="form-control" id="road_width_wanted" placeholder="Enter Road Width">
                    </div>
                    <div class="col-8 mb-3 ">

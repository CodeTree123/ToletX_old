    ...
    <div class="row shadow p-4 rounded my-5  ">
            ...
            <form method="POST" action="{{ route('post_community_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        <label for="title_rented" class="form-label me-2 fw-bold">Community Hall Name</label>
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="seat" type="number" class="form-control" id="Seating_rented" placeholder="Enter No of Seating Arrangement">
                    </div>
        ...
        <div class="col-12" id="wanted" style="display: none;">
            <form method="POST" action="{{ route('post_community_wanted') }}">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        <label for="title_wanted" class="form-label me-2 fw-bold">Community Hall Name</label>
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <input name="seat" type="number" class="form-control" id="Seating_wanted" placeholder="Enter No of Seating Arrangement">
                    </div>
                    <div class="col-8 mb-3 ">

        ...
        <div class="col-12" id="rented" style="display: none;">
            <form method="POST" action="{{ route('post_room_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3 ">
                        <label for="guest_rented" class="form-label me-2 fw-bold">Guest Count</label>
                        <input name="guest_count" type="number" class="form-control" id="guest_rented" placeholder="Enter guest count">
                    </div>
        ...
        <div class="col-12" id="wanted" style="display: none;">
            <form method="POST" action="{{ route('post_room_wanted') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mb-3 ">
                        <label for="guest_wanted" class="form-label me-2 fw-bold">Guest Count</label>
                        <input name="guest_count" type="number" class="form-control" id="guest_wanted" placeholder="Enter guest count">
                    </div>
                    <div class="col-8 mb-3 ">

    ...
    <div class="row shadow p-4 rounded my-5  ">
            ...
            <form method="POST" action="{{ route('post_restuarant_rented') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        <label for="resort_name_rented" class="form-label me-2 fw-bold">Resort Name</label>
                        <input name="resort_name" type="text" class="form-control" id="resort_name_rented" placeholder="Enter Hotel name">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-4 mb-3 ">
                        ...
                        <div class="form-check ms-5 mb-2">
                            <input class="form-check-input" type="checkbox" id="attatched_toilet_rented" name="attatched_toilet">
                        ...
                        <div class="form-check ms-5 mb-2">
                            <input class="form-check-input" type="checkbox" id="swimmingpool_rented" name="swimmingpool">
                            <label class="form-check-label" for="swimmingpool_rented">
                                swimming Pool
                            </label>
                        </div>
                        <div class="form-check ms-5 mb-2">
        ...
        <div class="col-12" id="wanted" style="display: none;">
            <form method="POST" action="{{ route('post_restuarant_wanted') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-4 mb-3 ">
                        <label for="resort_name_wanted" class="form-label me-2 fw-bold">Resort Name</label>
                        <input name="resort_name" type="text" class="form-control" id="resort_name_wanted" placeholder="Enter Hotel name">
                    </div>
                    <div class=" col-4 mb-3">
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <div class="row ms-5">
                            ...
                            <div class="col-2 form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="swimmingpool_wanted" name="swimmingpool">
                                <label class="form-check-label" for="swimmingpool_wanted">
                                    swimming Pool
                                </label>
                            </div>
                            <div class="col-2 form-check mb-2">

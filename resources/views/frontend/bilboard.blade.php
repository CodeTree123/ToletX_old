                            ...
                            <div class="price-range-block mb-3">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        ...
                                        <div class="d-flex  ">
                                            <input type="number" name="[price]" min=100 max="9900000" oninput="validity.valid||(value='100');" id="min_price" class="price-range-field form-control me-2" placeholder="Min-price" />

                                            <input type="number" name="[price]" min=100 max="10000000" oninput="validity.valid||(value='1000000');" id="max_price" class="price-range-field form-control" placeholder="Max-price" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="sliderText"> Area Range </div>
                                        <div class="d-flex  ">
                                            <input type="number" name="filter[size]" min=100 max="9900000" oninput="validity.valid||(value='100');" id="min_price" class="price-range-field form-control me-2" placeholder="Min-size" />
                                            <input type="number" name="filter[size]" min=100 max="10000000" oninput="validity.valid||(value='1000000');" id="max_price" class="price-range-field form-control" placeholder="Max-size" />
                                        </div>
                                    </div>
                                </div>
                            </div>

                    ...
                    <div class="login-form shadow py-3 ">
                        ...
                        <div class="  text-center  ">
                                ...
                                <a href="{{route('profile')}}" class="img-a ">
                                    ...
                                    <img src="{{asset('/uploads/registers/man-dummy.png') }}" class="rounded-circle mx-auto img-img" alt="" srcset="" >
                                    @else
                                    <img src="{{asset('/uploads/registers') }}/{{(Auth::user()->photo)}}" class="rounded-circle mx-auto img-img" alt="" srcset="" id="test">
                                    </a>
                                    @endif
                                </div>
                            <div class="name mt-2">

        ...
        <div class="row">
                    ...
                    <section id="default" class="padding-top0">
                        <div class="row">
                            <div class="xzoom-container">
                                <img class="xzoom zoom_main" id="xzoom-default" src="{{ asset('/uploads/factories') }}/{{ $list->photo }}" xoriginal=" {{ asset('/uploads/factories') }}/{{ $list->photo }}" />
                                <div class="xzoom-thumbs" style="display:flex; margin-top:10px;">
                                    <a href=" {{ asset('/uploads/factories') }}/{{ $list->photo1 }}">
                                        <img class="xzoom-gallery thumb" width="50" src="{{ asset('/uploads/factories') }}/{{ $list->photo1 }}" xpreview=" {{ asset('/uploads/factories') }}/{{ $list->photo1 }}">
                                    </a>
                                    <a href="{{ asset('/uploads/factories') }}/{{ $list->photo2 }}">
                                        <img class="xzoom-gallery thumb" width="50" src="{{ asset('/uploads/factories') }}/{{ $list->photo2 }}">
                                    </a>
                                    <a href="{{ asset('/uploads/factories') }}/{{ $list->photo3 }}">
                                        <img class="xzoom-gallery thumb" width="50" src="{{ asset('/uploads/factories') }}/{{ $list->photo3 }}">
                                    </a>
                                    <a href="{{ asset('/uploads/factories') }}/{{ $list->photo4 }}">
                                        <img class="xzoom-gallery thumb" width="50" src="{{ asset('/uploads/factories') }}/{{ $list->photo4 }}">
                                    </a>
                                    <a href="{{ asset('/uploads/factories') }}/{{ $list->photo5 }}">
                                        <img class="xzoom-gallery thumb" width="50" src="{{ asset('/uploads/factories') }}/{{ $list->photo5 }}">
                                    </a>
                                    <a href="{{ asset('/uploads/factories') }}/{{ $list->photo6 }}">
                                        <img class="xzoom-gallery thumb" width="50" src="{{ asset('/uploads/factories') }}/{{ $list->photo6 }}">
                                    </a>
                                    <a href="{{ asset('/uploads/factories') }}/{{ $list->photo }}">
                                        <img class="xzoom-gallery thumb" width="50" src="{{ asset('/uploads/factories') }}/{{ $list->photo }}">
                                    </a>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 product-div-right">
                <div>
                    <h2>Posted By-</h2>
                    <div class="d-flex">
                        <img src="{{asset('/uploads/registers')}}/{{$list->Factory_relationBetweenUser->photo}}" class="rounded-circle single-pg-img" alt="" srcset="">

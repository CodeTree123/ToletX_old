        ...
        <div class="row">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body ratio  ratio-16x9 px-3">
                                    <iframe width="460" height="315" src="{{ $list->video }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 product-div-right">
                <div>
                    ...
                    <h2 class="fw-bold my-2">{{$list->Room_relationBetweenUser->name}}</h2>
                    <div class=" ">

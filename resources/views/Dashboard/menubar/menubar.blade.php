            ...
            <ul id="accordion-menu">
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                        <span class="micon dw dw-house-1"></span><span >User</span>
                    </a>
                    <ul class="submenu">
                        <li><a href="{{route('list_user')}}">User List</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                ...
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                        <span class="micon dw dw-library"></span><span class="mtext">Advertise</span>
                    </a>
                    <ul class="submenu">
                        <li><a href="{{route('get_add')}}">Add Advertise</a></li>
                    </ul>
                </li>
            </ul>
        </div>

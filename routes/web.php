    ...
    */
    ...
    Route::get('/post/room', [App\Http\Controllers\UserWantedController::class, 'post_room'])->name('post_room'); //m
    ...
    Route::get('/post/flat', [App\Http\Controllers\UserWantedController::class, 'post_flat'])->name('post_flat'); //modify
    ...
    Route::post('/post/hotel/rented', [App\Http\Controllers\DashboardController::class, 'post_hotel_rented'])->name('post_hotel_rented');
    Route::post('/post/hotel/wanted', [App\Http\Controllers\DashboardController::class, 'post_hotel_wanted'])->name('post_hotel_wanted');
    ...
    //end Frontend
    //Wanted folder er sob "post_...."blade file gula design fix korte hobe
    //end Ad
